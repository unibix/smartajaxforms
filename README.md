...
3. для лишней безопасности можете переименовать файл showleads.php в любое другое, например: crm.php

4. чтобы подключить яндекс капчу скрытую нужно в форме добавить поле 
